...
def fwd_kernel(
    ...
    Q_ptrs = Q_ptr + (rows_offset_Q[:, None] * stride_qm + cols_offset[None, :] * stride_qd)
    ...
    for i in range(0, N_CTX, BLOCK_N):
        ...
        K_ptrs = K_ptr + (rows_offset_KV[:, None] * stride_km + cols_offset[None, :] * stride_kd)
        V_ptrs = V_ptr + (rows_offset_KV[:, None] * stride_vm + cols_offset[None, :] * stride_vd)
    ...
    O_ptrs = Out_ptr + (rows_offset_Q[:, None] * stride_om + cols_offset[None, :] * stride_od)
